...
<?php
  if ($configurateur_serie === true){
    ?>
      <div class="config__term__item config__term__item__add config__term__item__adds--jante config__term__item--jante config__term__item--active" data-cat="<?= $taxo ?>" data-price="<?= $configurateur_price ?>" data-slug="<?= $configurateur_slug ?>" data-title="<?= $configurateur_title ?>">
    <?php
  }
  else {
    ?>

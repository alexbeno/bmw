...
<div class="securite__aide">
  <div class="securite__aide__content content">
    <div class="securite__aide__title title">
    ...
    <div class="securite__aide__content__text content__text"><?= $securite_content;  ?></div>
  </div> 
  <div class="securite__aide__slider slider">
  ...
  <p class="securite__aide__number numberSection">02</p>
</div>
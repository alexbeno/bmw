const sophisto_grey_blue_jante_625_turbine_baseUrl = baseurl.siteurl + "/wp-content/themes/flinked/dist/assets/image/configurateur/jante/sophisto_grey_blue_jante_625_turbine/"
const sophisto_grey_blue_jante_625_turbine = {
  sortKey: [],
...
for (let key in sophisto_grey_blue_jante_625_turbine) {
  let current = key;
  if(current === "sortKey") {
...
export default sophisto_grey_blue_jante_625_turbine;
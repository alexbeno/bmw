const sophisto_grey_blue_jante_470_rayons_baseUrl = baseurl.siteurl + "/wp-content/themes/flinked/dist/assets/image/configurateur/jante/sophisto_grey_blue_jante_470_rayons/"
const sophisto_grey_blue_jante_470_rayons = {
  sortKey: [],
...
for (let key in sophisto_grey_blue_jante_470_rayons) {
  let current = key;
  if(current === "sortKey") {
...
export default sophisto_grey_blue_jante_470_rayons;
const ionic_silver_jante_470_rayons_baseUrl = baseurl.siteurl + "/wp-content/themes/flinked/dist/assets/image/configurateur/jante/ionic_silver_jante_470_rayons/"
const ionic_silver_jante_470_rayons = {
  sortKey: [],
...
for (let key in ionic_silver_jante_470_rayons) {
  let current = key;
  if(current === "sortKey") {
...
export default ionic_silver_jante_470_rayons;
const ionic_silver_jante_625_turbine_baseUrl = baseurl.siteurl + "/wp-content/themes/flinked/dist/assets/image/configurateur/jante/ionic_silver_jante_625_turbine/"
const ionic_silver_jante_625_turbine = {
  sortKey: [],
...
for (let key in ionic_silver_jante_625_turbine) {
  let current = key;
  if(current === "sortKey") {
...
export default ionic_silver_jante_625_turbine;
const crystal_white_blue_jante_625_turbine_baseUrl = baseurl.siteurl + "/wp-content/themes/flinked/dist/assets/image/configurateur/jante/crystal_white_blue_jante_625_turbine/"
const crystal_white_blue_jante_625_turbine = {
  sortKey: [],
...
for (let key in crystal_white_blue_jante_625_turbine) {
  let current = key;
  if(current === "sortKey") {
...
export default crystal_white_blue_jante_625_turbine;
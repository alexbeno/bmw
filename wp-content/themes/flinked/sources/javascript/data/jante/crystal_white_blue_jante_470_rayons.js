const crystal_white_blue_jante_470_rayons_baseUrl = baseurl.siteurl + "/wp-content/themes/flinked/dist/assets/image/configurateur/jante/crystal_white_blue_jante_470_rayons/"
const crystal_white_blue_jante_470_rayons = {
  sortKey: [],
...
for (let key in crystal_white_blue_jante_470_rayons) {
  let current = key;
  if(current === "sortKey") {
...
export default crystal_white_blue_jante_470_rayons;